...
import net.notvergin.betterpearls.entities.projectiles.ThrownBlockPearl;
import net.notvergin.betterpearls.entities.projectiles.ThrownExplosivePearl;
import net.notvergin.betterpearls.entities.projectiles.ThrownHomingPearl;
...
public class ModEntities
{
    ...
    public static final RegistryObject<EntityType<ThrownHomingPearl>> THROWN_HOMING_PEARL = ENTITY_TYPES.register("thrown_homing_pearl", () -> EntityType.Builder.<ThrownHomingPearl>of(ThrownHomingPearl::new, MobCategory.MISC).sized(0.25F, 0.25F).build("thrown_homing_pearl"));
