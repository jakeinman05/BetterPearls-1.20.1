...
import net.notvergin.betterpearls.entities.projectiles.ThrownRocketPearl;

public class RocketPearlItem extends Item
{
    public RocketPearlItem(Item.Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand)
    {
        ...
        if (!pLevel.isClientSide) {
            /////////////////////////////////// new Thrown Entity
            ThrownRocketPearl pearl = new ThrownRocketPearl(pLevel, pPlayer);
