...
public class HomingPearlItem extends Item
{
    public HomingPearlItem(Item.Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand)
    {
        ...
        if (!pLevel.isClientSide) {
            /////////////////////////////////// new Thrown Entity
            ThrownHomingPearl pearl = new ThrownHomingPearl(pLevel, pPlayer);
